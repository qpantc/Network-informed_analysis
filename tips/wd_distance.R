...
# g1 <- network_metrics_with_combination(1253,items=node_lsit,all_edges = all_edges)
# g2 <- network_metrics_with_combination(124575853,items=node_lsit,all_edges = all_edges)
# 
# d(g2,Net_full,w1=0.45,w2=0.45,w3=0.1)
# PowerSetsBinary(1253)
# PowerSetsBinary(124575853)
# PowerSetsBinary(124575854)
